...
echo "╚═══════════════════════════════════════════════════════════╝"
echo ""
echo "  MAU LEBIH GACOR? BUY APP/MODULE PREMIUM KAMI DI SALURAN RESMI #Leak By @kepental"
am start -a android.intent.action.VIEW -d "https://telegram.me/kembungjir"
